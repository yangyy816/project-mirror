...
| OpenCV `3.4.11` minimal source overlay                          | P2-M3 V03 isolated Face Landmarker build  | ISOLATED BUILD LOCK ONLY        | ADR-033；Linux offline build 已通过；SBOM、漏洞、clean reproduction 与 Windows parity 未通过前不得运行 |
