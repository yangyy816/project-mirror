...
| OpenCV `5.0.0` minimal source-built `core,imgproc` closure      | P2-M4 deterministic transform candidate   | PREREGISTRATION_REQUIRED          | 新 candidate ID、exact toolchain、双平台可复现、license/SBOM/vulnerability、zero-egress、replacement boundary         |
