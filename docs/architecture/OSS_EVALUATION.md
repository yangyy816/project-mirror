...
| OpenCV `3.4.11` minimal source overlay                          | P2-M3 V03 isolated Face Landmarker build  | ISOLATED BUILD LOCK ONLY        | ADR-033；Linux offline bit reproduction 已通过；OouraFFT 分发权、剩余漏洞处置与 Windows parity 未通过前不得运行 |
