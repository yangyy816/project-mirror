...
| OpenCV `5.0.0` minimal source-built `core,imgproc` closure      | P2-M4 deterministic transform candidate   | POC_PREREGISTERED                 | exact toolchains、双平台 clean reproduction、license/SBOM/vulnerability、zero-egress、determinism、replacement boundary |
