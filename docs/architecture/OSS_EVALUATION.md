...
| OpenCV `5.0.0` / `opencv-python-headless==5.0.0.93`             | P2-M4/P3/P5/P6 确定性变换、warp、mask、QA | POC_PREREGISTERED                 | T04 exact wheels、Python 3.13、Windows/Linux/Docker、license/SBOM/vulnerability、zero-network、性能、确定性、替换边界 |
