...
| OpenCV `3.4.11` minimal source overlay                          | P2-M3 V03 isolated Face Landmarker build  | ISOLATED BUILD LOCK ONLY        | ADR-033；仅 `core,imgproc`；offline build、SBOM、漏洞、符号与 Windows/Linux parity 未通过前不得运行 |
