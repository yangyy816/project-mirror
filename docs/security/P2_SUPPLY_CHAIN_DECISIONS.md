...
| MediaPipe source-built zero-telemetry v1 | exact `v0.10.35` commit `f8ef212d5c962c0e853db7e59d217056b187084b`; ADR-032                                                                | Public source uses a dummy logger; minimal C ABI/CA-bundle patch; Windows and hardened Linux clean reproduction plus path/network-surface scans pass after R17/R18; model/data disposition remains independent | `STAGE_B_CROSS_PLATFORM_REPRODUCIBILITY_PASS_AUDIT_IN_PROGRESS`; no runtime/model approval         | Close updated license/SBOM/vulnerability dispositions, then execute both-platform Stage C                                                                                                   |
