...
| MediaPipe source-built zero-telemetry v1 | exact `v0.10.35` commit `f8ef212d5c962c0e853db7e59d217056b187084b`; ADR-032                                        | Stage A source-feasibility only; patch/toolchain/build artifact not yet frozen; model/data disposition remains independent                                             | `PREREGISTERED_SOURCE_FEASIBILITY_ONLY`; no build/install/runtime approval                         | Trace and remove the complete Clearcut/telemetry/HTTP/network/CA-bundle closure, then freeze exact cross-platform build evidence before execution                                           |
