...
| P2-M3   | EXECUTING | T05 run `31968433284` 全绿；MediaPipe 0.10.35 telemetry FAIL；replacement/T07–T08 pending |
...
| P2-M3     | EXECUTING | T05 run `31968433284` 全绿；MediaPipe 0.10.35 telemetry FAIL；Vision replacement pending |
