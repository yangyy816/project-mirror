...
| P2-M3   | EXECUTION_READY | Synthetic normalization/base QA；ADR-027 与 bounded tasks 已冻结 |
...
| P2-M3     | EXECUTION_READY | Synthetic normalization/base identity QA；ADR-027 与 T01–T08 已冻结              |
