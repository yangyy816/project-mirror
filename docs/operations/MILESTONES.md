...
| Phase 2 | COMMITTED | Synthetic Dataset Engine；P2-M1–M4 已冻结，P2-M5 T05 接受为 FURTHER_RESEARCH |
...
| P2-M5     | EXECUTING | T05 accepted `FURTHER_RESEARCH`；MVR `NOT_EVALUATED`，T06/M6 保持关闭            |
