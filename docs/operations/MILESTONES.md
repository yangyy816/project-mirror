...
| P2-M7     | COMMITTED | Internal operations, cost and observability；M2 contracts 已冻结；T01/R01 evidence reconciliation candidate pending tracked R02 evidence；T02 remains closed |
