...
| Phase 2 | COMMITTED | Synthetic Dataset Engine；P2-M1–M4 已冻结，P2-M5 T01 已通过并开始执行       |
...
| P2-M5     | EXECUTING | Variable isolation, duplicate and diversity QA；T01 exact-SHA Gate 已接受，T02/T04 开放 |
