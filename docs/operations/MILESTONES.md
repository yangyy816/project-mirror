...
| Phase 2 | COMMITTED | Synthetic Dataset Engine；P2-M1–M4 已冻结，P2-M5 T03 已接受并开放 T05       |
...
| P2-M5     | EXECUTING | Variable isolation, duplicate and diversity QA；T03 exact-SHA Gate 已接受，T05 开放 |
