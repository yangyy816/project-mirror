...
| P2-M3   | EXECUTING | planning run `31959813830` 全绿；T02–T05 schema/normalization/QA/orchestration 本地通过 |
...
| P2-M3     | EXECUTING | planning run `31959813830` 全绿；T02–T05 含 Worker/identity orchestration 本地通过 |
