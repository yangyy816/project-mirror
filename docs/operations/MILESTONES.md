...
| Phase 2 | COMMITTED | Synthetic Dataset Engine；P2-M1–M4 已冻结，P2-M5 仅待 rolling-wave refinement |
...
| P2-M5     | COMMITTED | Variable isolation, duplicate and diversity QA；仅开放 rolling-wave refinement   |
