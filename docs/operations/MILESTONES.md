...
| P2-M3   | EXECUTING | T05 run `31968433284` 全绿；upstream MediaPipe telemetry FAIL；ADR-032 Stage A PASS，build freeze / T07–T08 pending |
...
| P2-M3     | EXECUTING | T05 run `31968433284` 全绿；upstream MediaPipe telemetry FAIL；ADR-032 Stage A PASS，build freeze pending |
