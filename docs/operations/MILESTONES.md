...
| Phase 2 | COMMITTED | P2-M1–M4 已冻结；P2-M5 CC02-C contract-only candidate，replay/后续 Gate 关闭 |
...
| P2-M5     | EXECUTING | CC02-B `96ca439` 已接受；CC02-C contract-only candidate，replay/后续 Gate 关闭   |
