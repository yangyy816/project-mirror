...
`P2_M5_IMPLEMENTATION: CC_P2_M5_01_C_LOCAL_STOP_CHECKPOINT`
...
`CC_P2_M5_01_C_EXECUTION: LOCAL_FURTHER_RESEARCH_PENDING_TRACKED_EVIDENCE`

`CC_P2_M5_01_D_TO_E: CLOSED_BY_STAGE_C_COMPLETE_CASE_RULE`

`P2_M5_NEXT_ACTION: STAGE_C_CANDIDATE_SAME_SHA_GATE`
