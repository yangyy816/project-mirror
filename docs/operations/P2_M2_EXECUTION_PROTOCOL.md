...
`P2_M2_REPAIR_P2_M2_R01: PASS`

`P2_M2_REPAIR_P2_M2_R02: PASS`

`P2_M2_T04: TASK_ACCEPTED`

`P2_M2_T05: TASK_ACCEPTED`

`P2_M2_REPAIR_P2_M2_R03: PASS`

`P2_M2_REPAIR_P2_M2_R04: PASS`
...
`P2_M2_ACCEPTANCE_CLOSURE_CI: PASS_AT_e211adb_RUN_31958454155`
