# ruff: noqa: E501
"""Principal-owned D02-R2 E2 evidence root and two-copy registry.

This is the isolated writable Epoch 02 implementation accepted by
``P3_P7_D02_R2_EXECUTION_EPOCH_02``.  The E1 module remains byte-identical and
read-only; this module never opens an E1 root.  It has no PostgreSQL, M3, M4,
migration, or public API dependency.  Callers must supply an already accepted
tracked E2 implementation SHA before creating the designated E2 root.
"""
...
REGISTRY_IMPLEMENTATION_ACCEPTANCE_SCHEMA: Final = (
    "mirror.demo/D02R2Epoch2ExecutionImplementationAcceptance/v1"
)
...
ACCEPTED_PLAN_SHA: Final = "3d3ce14556de8240cfb913a85bec2aaa8052aeae"
ACCEPTED_PLAN_TREE: Final = "8632ea833b8b50afb90a4df39d22ea7f56c6d5d3"
TASK_ID: Final = "P3_P7_D02_R2_EXECUTION_02"
SOURCE_PRODUCER_TASK_ID: Final = "P3_P7_D02_R2_SOURCE_COHORT_02"
REVIEW_TASK_ID: Final = "P3_P7_D02_R2_EVIDENCE_REVIEW_02"
DISPATCH_EPOCH: Final = 2
PRIVATE_NAMESPACE_ID: Final = "pm-p3p7-d02-r2-cc08-e2"
EVIDENCE_ROOT_ID: Final = "P3_P7_D02_R2_CC08_E2_EVIDENCE_ROOT"
EVIDENCE_ROOT_BASENAME: Final = "p3-p7-d02-r2-cc08-e2-evidence"
ROOT_RECEIPT_LOGICAL_NAME: Final = "D02_R2_EVIDENCE_ROOT_NAME_RECEIPT.json"
REGISTRY_COPY_A_ID: Final = "P3_P7_D02_R2_CC08_E2_REGISTRY_A"
REGISTRY_COPY_B_ID: Final = "P3_P7_D02_R2_CC08_E2_REGISTRY_B"
...
GENERATION_DISPATCH_STATE: Final = "E2_RESERVE_ACTIVATED_PENDING_PRIVATE_PREFLIGHT"
...
REGISTRY_IMPLEMENTATION_AUTHORITY_ID: Final = "P3_P7_D02_R2_EPOCH_02_IMPLEMENTATION_ACCEPTANCE_01"
REGISTRY_IMPLEMENTATION_TASK_ID: Final = "P3_P7_D02_R2_R08_EPOCH_02_IMPLEMENTATION"
REGISTRY_IMPLEMENTATION_REVIEW_TASK_ID: Final = "P3_P7_D02_R2_EPOCH_02_EXACT_SHA_REVIEW_01"
...
REGISTRY_IMPLEMENTATION_ACCEPTANCE_PATH: Final = (
    "docs/operations/P3_P7_D02_R2_EPOCH_02_IMPLEMENTATION_ACCEPTANCE.json"
)
REGISTRY_SOURCE_REPO_PATH: Final = "services/api/src/mirror_api/demo_d02_r2_private_registry_e2.py"
REGISTRY_TEST_REPO_PATH: Final = "services/api/tests/test_demo_d02_r2_private_registry_e2.py"
REGISTRY_DIGEST_DEPENDENCY_REPO_PATH: Final = (
    "services/api/src/mirror_api/demo_measurement_quality.py"
)
E2_PLAN_REPO_PATH: Final = "docs/operations/P3_P7_D02_R2_EXECUTION_EPOCH_02.md"
E2_GENERATION_REPO_PATH: Final = "services/api/src/mirror_api/demo_d02_r2_generation_epoch2.py"
E2_GENERATION_TEST_REPO_PATH: Final = "services/api/tests/test_demo_d02_r2_generation_epoch2.py"
E2_RECEIVER_REPO_PATH: Final = "services/api/src/mirror_api/demo_d02_r2_generation_receiver.py"
E2_RECEIVER_TEST_REPO_PATH: Final = "services/api/tests/test_demo_d02_r2_generation_receiver.py"
REGISTRY_GOVERNED_PATHS: Final[tuple[str, ...]] = (
    E2_PLAN_REPO_PATH,
    REGISTRY_SOURCE_REPO_PATH,
    REGISTRY_TEST_REPO_PATH,
    E2_GENERATION_REPO_PATH,
    E2_GENERATION_TEST_REPO_PATH,
    E2_RECEIVER_REPO_PATH,
    E2_RECEIVER_TEST_REPO_PATH,
    REGISTRY_DIGEST_DEPENDENCY_REPO_PATH,
)
REGISTRY_AUTHORIZED_SCOPE: Final = "D02_R2_E2_ROOT_REGISTRY_RESERVE_REQUEST_AND_LOCAL_RECEIVER"
REGISTRY_PROHIBITED_SCOPE: Final[tuple[str, ...]] = (
    "IMAGEGEN_EXECUTION_BEFORE_PRIVATE_PREFLIGHT",
    "M3_M4_EXECUTION",
    "MIGRATION_OR_ORM",
...
def _execution_contract_payload_for_registry_implementation(
    ...
    *,
    ...
    _validate_authority(authority)
    if registry_implementation_sha != authority.registry_implementation_sha:
        _fail_root("registry implementation SHA is not the accepted E2 implementation")
    return {
...
def load_root_name_receipt(root: Path, authority: RootReceiptAuthority) -> JsonObject:
    ...
    expected = build_root_name_receipt(authority)
    if receipt != expected:
        _fail_root("E2 root receipt fixed authority does not replay")
    return receipt
